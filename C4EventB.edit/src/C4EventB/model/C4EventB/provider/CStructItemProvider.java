...
/**
 * This is the item provider adapter for a {@link C4EventB.model.C4EventB.CStruct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CStructItemProvider extends CDerivedTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 C4EventBPackage.Literals.CSTRUCT__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(C4EventBPackage.Literals.CSTRUCT__FIELDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CStruct.class)) {
			case C4EventBPackage.CSTRUCT__TYPE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case C4EventBPackage.CSTRUCT__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(C4EventBPackage.Literals.CSTRUCT__FIELDS,
				 C4EventBFactory.eINSTANCE.createCField()));
	}

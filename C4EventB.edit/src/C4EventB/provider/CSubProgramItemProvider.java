...
/**
 * This is the item provider adapter for a {@link C4EventB.CSubProgram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CSubProgramItemProvider extends CNamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(C4EventBPackage.Literals.CSUB_PROGRAM__PARAMETERS);
			childrenFeatures.add(C4EventBPackage.Literals.CSUB_PROGRAM__LOCAL_VARIABLES);
			childrenFeatures.add(C4EventBPackage.Literals.CSUB_PROGRAM__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(C4EventBPackage.Literals.CSUB_PROGRAM__PARAMETERS,
				 C4EventBFactory.eINSTANCE.createCParameter()));

		newChildDescriptors.add
			(createChildParameter
				(C4EventBPackage.Literals.CSUB_PROGRAM__LOCAL_VARIABLES,
				 C4EventBFactory.eINSTANCE.createCVariable()));

		newChildDescriptors.add
			(createChildParameter
				(C4EventBPackage.Literals.CSUB_PROGRAM__BODY,
				 C4EventBFactory.eINSTANCE.createCExpression()));
	}

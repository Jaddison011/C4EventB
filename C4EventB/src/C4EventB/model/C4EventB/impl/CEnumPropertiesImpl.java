 ...
 * </p>
 * <ul>
 *   <li>{@link C4EventB.model.C4EventB.impl.CEnumPropertiesImpl#getIntegralConstant <em>Integral Constant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CEnumPropertiesImpl extends CNamedElementImpl implements CEnumProperties {
	...
	protected EClass eStaticClass() {
		return C4EventBPackage.Literals.CENUM_PROPERTIES;
	}
	...
	public void setIntegralConstant(int newIntegralConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CENUM_PROPERTIES__INTEGRAL_CONSTANT, oldIntegralConstant, integralConstant));
	}

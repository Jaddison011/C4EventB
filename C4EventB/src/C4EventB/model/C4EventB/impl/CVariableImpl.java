 ...
 * </p>
 * <ul>
 *   <li>{@link C4EventB.model.C4EventB.impl.CVariableImpl#getValue <em>Value</em>}</li>
 *   <li>{@link C4EventB.model.C4EventB.impl.CVariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link C4EventB.model.C4EventB.impl.CVariableImpl#isIsConstant <em>Is Constant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CVariableImpl extends CNamedElementImpl implements CVariable {
	...
	protected EClass eStaticClass() {
		return C4EventBPackage.Literals.CVARIABLE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CVARIABLE__VALUE, oldValue, value));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CVARIABLE__TYPE, oldType, type));
	}
	...
	public void setIsConstant(boolean newIsConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CVARIABLE__IS_CONSTANT, oldIsConstant, isConstant));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case C4EventBPackage.CVARIABLE__VALUE:
				return getValue();
			case C4EventBPackage.CVARIABLE__TYPE:
				return getType();
			case C4EventBPackage.CVARIABLE__IS_CONSTANT:
				return isIsConstant();
		}

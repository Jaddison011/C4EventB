...
/**
 * This is the item provider adapter for a {@link C.ecore.CFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CFunctionItemProvider extends CSubProgramItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 C.ecore.EcorePackage.Literals.CFUNCTION__RETURN_TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((C.ecore.CFunction)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(C.ecore.CFunction.class)) {
			case C.ecore.EcorePackage.CFUNCTION__RETURN_TYPE:

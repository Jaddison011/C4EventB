 ...
 * </p>
 * <ul>
 *   <li>{@link ecore.CPreCondition#getPredicate <em>Predicate</em>}</li>
 * </ul>
 *
 * @see ecore.EcorePackage#getCPreCondition()
 * @model
 * @generated
 */
public interface CPreCondition extends CExpression {
	 ...
	 * @see ecore.EcorePackage#getCPreCondition_Predicate()
	 * @model
	 * @generated
	 */
	String getPredicate();
	...
	/**
	 * Sets the value of the '{@link ecore.CPreCondition#getPredicate <em>Predicate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

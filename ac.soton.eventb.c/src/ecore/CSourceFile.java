 ...
 * </p>
 * <ul>
 *   <li>{@link ecore.CSourceFile#getIncludeDirectives <em>Include Directives</em>}</li>
 * </ul>
 *
 * @see ecore.EcorePackage#getCSourceFile()
 * @model
 * @generated
 */
public interface CSourceFile extends CFile {
	 ...
	 * The list contents are of type {@link ecore.CIncludeDirective}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Include Directives</em>' containment reference list.
	 * @see ecore.EcorePackage#getCSourceFile_IncludeDirectives()

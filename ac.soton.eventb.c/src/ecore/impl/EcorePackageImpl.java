...
public class EcorePackageImpl extends EPackageImpl implements EcorePackage {
	 ...
	 * @generated
	 */
	public EAttribute getCField_Type() {
		return (EAttribute)cFieldEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCFunction_ReturnStatement() {
		return (EReference)cFunctionEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(cFieldEClass, CFIELD__TYPE);
		...
		createEReference(cFunctionEClass, CFUNCTION__RETURN_STATEMENT);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCField_Type(), ecorePackage.getEString(), "type", null, 0, 1, CField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCFunction_ReturnStatement(), this.getCExpression(), null, "returnStatement", null, 0, 1, CFunction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

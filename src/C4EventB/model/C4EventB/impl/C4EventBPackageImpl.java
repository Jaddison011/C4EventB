...
import C4EventB.model.C4EventB.CArray;
import C4EventB.model.C4EventB.CArrayElement;
import C4EventB.model.C4EventB.CDerivedType;
import C4EventB.model.C4EventB.CDiscreteType;
import C4EventB.model.C4EventB.CEnumProperties;
import C4EventB.model.C4EventB.CEnumeration;
import C4EventB.model.C4EventB.CExpression;
import C4EventB.model.C4EventB.CField;
import C4EventB.model.C4EventB.CFile;
import C4EventB.model.C4EventB.CFunction;
import C4EventB.model.C4EventB.CHeaderFile;
import C4EventB.model.C4EventB.CIncludeDirective;
import C4EventB.model.C4EventB.CNamedElement;
import C4EventB.model.C4EventB.CParameter;
import C4EventB.model.C4EventB.CPointer;
import C4EventB.model.C4EventB.CProcedure;
import C4EventB.model.C4EventB.CSourceFile;
import C4EventB.model.C4EventB.CStruct;
import C4EventB.model.C4EventB.CSubProgram;
import C4EventB.model.C4EventB.CTranslationUnit;
import C4EventB.model.C4EventB.CType;
 ...
 * @generated
 */
public class C4EventBPackageImpl extends EPackageImpl implements C4EventBPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see C4EventB.model.C4EventB.C4EventBPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private C4EventBPackageImpl() {
		super(eNS_URI, C4EventBFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link C4EventBPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static C4EventBPackage init() {
		if (isInited) return (C4EventBPackage)EPackage.Registry.INSTANCE.getEPackage(C4EventBPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredC4EventBPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		C4EventBPackageImpl theC4EventBPackage = registeredC4EventBPackage instanceof C4EventBPackageImpl ? (C4EventBPackageImpl)registeredC4EventBPackage : new C4EventBPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theC4EventBPackage.createPackageContents();

		// Initialize created meta-data
		theC4EventBPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theC4EventBPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(C4EventBPackage.eNS_URI, theC4EventBPackage);
		return theC4EventBPackage;
	}
	 ...
	 * @generated
	 */
	public C4EventBFactory getC4EventBFactory() {
		return (C4EventBFactory)getEFactoryInstance();
	}

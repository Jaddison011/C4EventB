 ...
 * </p>
 * <ul>
 *   <li>{@link C4EventB.model.C4EventB.impl.CArrayImpl#getElementType <em>Element Type</em>}</li>
 *   <li>{@link C4EventB.model.C4EventB.impl.CArrayImpl#getSize <em>Size</em>}</li>
 *   <li>{@link C4EventB.model.C4EventB.impl.CArrayImpl#getArrayElements <em>Array Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CArrayImpl extends CDerivedTypeImpl implements CArray {
	...
	protected EClass eStaticClass() {
		return C4EventBPackage.Literals.CARRAY;
	}
	...
	public void setElementType(String newElementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CARRAY__ELEMENT_TYPE, oldElementType, elementType));
	}
	...
	public void setSize(int newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CARRAY__SIZE, oldSize, size));
	}
	...
	public EList<CArrayElement> getArrayElements() {
		if (arrayElements == null) {
			arrayElements = new EObjectContainmentEList<CArrayElement>(CArrayElement.class, this, C4EventBPackage.CARRAY__ARRAY_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case C4EventBPackage.CARRAY__ARRAY_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case C4EventBPackage.CARRAY__ELEMENT_TYPE:
				return getElementType();
			case C4EventBPackage.CARRAY__SIZE:
				return getSize();
			case C4EventBPackage.CARRAY__ARRAY_ELEMENTS:

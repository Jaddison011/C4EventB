 ...
 * </p>
 * <ul>
 *   <li>{@link C4EventB.model.C4EventB.impl.CNamedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link C4EventB.model.C4EventB.impl.CNamedElementImpl#getEndname <em>Endname</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CNamedElementImpl extends MinimalEObjectImpl.Container implements CNamedElement {
	...
	protected EClass eStaticClass() {
		return C4EventBPackage.Literals.CNAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CNAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public void setEndname(String newEndname) {
		...
		endname = newEndname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, C4EventBPackage.CNAMED_ELEMENT__ENDNAME, oldEndname, endname));
	}

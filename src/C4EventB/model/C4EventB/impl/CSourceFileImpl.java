 ...
 * </p>
 * <ul>
 *   <li>{@link C4EventB.model.C4EventB.impl.CSourceFileImpl#getIncludeDirectives <em>Include Directives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CSourceFileImpl extends CFileImpl implements CSourceFile {
	...
	protected EClass eStaticClass() {
		return C4EventBPackage.Literals.CSOURCE_FILE;
	}
	...
	public EList<CIncludeDirective> getIncludeDirectives() {
		if (includeDirectives == null) {
			includeDirectives = new EObjectContainmentEList<CIncludeDirective>(CIncludeDirective.class, this, C4EventBPackage.CSOURCE_FILE__INCLUDE_DIRECTIVES);
		}
